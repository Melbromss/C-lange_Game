...
void showchart(int curp,char player[4])
		...
		switch(ch)
		{
			...
			system("cls");
					...
					if(cur_pos1<101){
						if(cur_pos1==99)
						{
						showchart(1,"$P1$");//snake
						}
						if(cur_pos1==65)
						{
						showchart(40,"$P1$");//snake
						}
						if(cur_pos1==25)
						{
						showchart(9,"$P1$");//snake
						}
						if(cur_pos1==70)
						{
						showchart(93,"$P1$");//ladder
						}
						if(cur_pos1==60)
						{
						showchart(83,"$P1$");//ladder
						}
						if(cur_pos1==13)
						{
						showchart(42,"$P1$");//ladder
						}
						else{
							showchart(cur_pos1,"$P1$");
						}
